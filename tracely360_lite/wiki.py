...
def _community_article(
    ...
    lines += ["---", "", "*Part of the tracely360-lite knowledge wiki. See [[index]] to navigate.*"]
    return "\n".join(lines)
...
def _index_md(
    ...
    lines: list[str] = [
        ...
        "",
        "> Auto-generated by tracely360-lite. Start here — read community articles for context, then drill into god nodes for detail.",
        "",
