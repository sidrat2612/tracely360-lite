...
def to_cypher(G: nx.Graph, output_path: str) -> None:
    lines = ["// Neo4j Cypher import - generated by /tracely360", ""]
...
def to_obsidian(
    ...
    # Map file_type → tracely360 tag
    _FTYPE_TAG = {
        "code": "tracely360/code",
        "document": "tracely360/document",
        "paper": "tracely360/paper",
        "image": "tracely360/image",
    }
    ...
    for idx, cid in enumerate(sorted_cids):
        ...
        for m_idx, node_id in enumerate(sorted_members):
            ...
            canvas_nodes.append({
                "id": f"n_{node_id}",
                "type": "file",
                "file": f"tracely360/obsidian/{fname}.md",
                "x": nx_x,
                "y": nx_y,
                "width": 180,
                "height": 60,
